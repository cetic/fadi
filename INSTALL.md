...
To access a service in your browser, you need to setup entries in your /etc/hosts file to route [http://fadi.minikube] to our cluster.
...
We should now be able to visit the different services behind [http://fadi.minikube]. For instance, you can access Grafana in the browser at [http://fadi.minikube/grafana].
